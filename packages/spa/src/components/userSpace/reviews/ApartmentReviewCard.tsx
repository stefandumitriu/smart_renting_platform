...
const ApartmentReviewCard: React.FC<ReviewProps> = ({
  review,
}: ReviewProps) => {
        ...
        <Grid container item xs={12} sm={7} flexDirection="column">
          <Grid item container columnSpacing={2}>
            ...
            <Grid item xs={12} sm="auto">
              <StyledRating readOnly value={review.comfortRating} />
            </Grid>
          </Grid>
          <Grid item container columnSpacing={2}>
            <Grid item xs={12} sm={3}>
            ...
            <Grid item xs={12} sm="auto">
              <StyledRating readOnly value={review.locationRating} />
            </Grid>
          </Grid>
          <Grid item container columnSpacing={2}>
            <Grid item xs={12} sm={3}>
            ...
            <Grid item xs={12} sm="auto">
              <StyledRating readOnly value={review.qualityRating} />
            </Grid>
          </Grid>
          <Grid item>
...
export default ApartmentReviewCard;
